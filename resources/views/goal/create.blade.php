                ...
                <div class="card-body p-4">
                    <form action="{{ route('goal.store') }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <option value="{{ \App\Enums\GoalStatus::InProgress->value }}" {{ old('status') === \App\Enums\GoalStatus::InProgress->value ? 'selected' : '' }}>{{ __('goal.in_progress') }}</option>
                            <option value="{{ \App\Enums\GoalStatus::Completed->value }}" {{ old('status') === \App\Enums\GoalStatus::Completed->value ? 'selected' : '' }}>{{ __('goal.completed') }}</option>
                            <option value="{{ \App\Enums\GoalStatus::Cancelled->value }}" {{ old('status') === \App\Enums\GoalStatus::Cancelled->value ? 'selected' : '' }}>{{ __('goal.cancelled') }}</option>
                                </select>
