@php
    ...
    $config = [
        'success' => ['icon' => 'success', 'color' => '#198754', 'title' => __('payment.success_title'), 'message' => __('payment.success_message')],
        'canceled' => ['icon' => 'failed', 'color' => '#dc3545', 'title' => __('payment.canceled_title'), 'message' => __('payment.canceled_message')],
    ];
