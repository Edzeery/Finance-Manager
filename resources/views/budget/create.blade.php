                                ...
                                <div id="categories-container">
                                    @foreach($categories as $cat)
                                        @php
                                            ...
                                            $oldUsePct = old('categories.' . $idx . '.use_percentage', '0');
                                        ...
                                        <div class="category-row d-flex align-items-center gap-3 mb-2 p-2" style="background:var(--bg); border-radius:8px" data-default-percentage="{{ $defaultPct ?? '' }}">
                                            ...
                                            <div class="d-flex align-items-center gap-2 flex-shrink-0">
                                                ...
                                                <div class="input-group amount-group" style="width:200px; {{ $isPctMode ? 'display:none' : '' }}">
                                                    ...
                                                    <input type="number" step="0.01" min="0" name="categories[{{ $idx }}][allocated_amount]" class="form-custom category-amount @error('categories.' . $idx . '.allocated_amount') is-invalid @enderror" style="width:120px" placeholder="0.00" value="{{ old('categories.' . $idx . '.allocated_amount') }}">
                                                ...
                                                <div class="input-group percentage-group" style="width:130px; {{ $isPctMode ? '' : 'display:none' }}">
                                                    <input type="number" step="0.01" min="0" max="100" name="categories[{{ $idx }}][percentage]" class="form-custom category-percentage @error('categories.' . $idx . '.percentage') is-invalid @enderror" placeholder="0" value="{{ old('categories.' . $idx . '.percentage') }}">
