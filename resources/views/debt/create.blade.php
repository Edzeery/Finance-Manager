<x-app-layout>
    <x-slot:title>{{ __('debt.add') }} - {{ config('app.name') }}</x-slot>
    <x-slot:page-title>{{ __('debt.add') }}</x-slot>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="number" step="0.01" min="0" name="total_amount" value="{{ old('total_amount') }}" class="form-custom @error('total_amount') is-invalid @enderror" required placeholder="0.00">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="number" step="0.01" min="0" name="paid_amount" value="{{ old('paid_amount', 0) }}" class="form-custom @error('paid_amount') is-invalid @enderror" placeholder="0.00">
                                    <span class="input-group-text" style="background:var(--bg); border:1px solid var(--border); border-radius:0 8px 8px 0; color:var(--text-muted); font-size:13px">{{ config('finance.currency_symbol') }}</span>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="due_date" value="{{ old('due_date') }}" class="form-custom @error('due_date') is-invalid @enderror">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="reminder_date" value="{{ old('reminder_date') }}" class="form-custom @error('reminder_date') is-invalid @enderror">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" class="form-custom @error('description') is-invalid @enderror" rows="3" maxlength="1000">{{ old('description') }}</textarea>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="notes" class="form-custom @error('notes') is-invalid @enderror" rows="3" maxlength="1000">{{ old('notes') }}</textarea>
                                @error('notes') <div class="text-danger mt-1" style="font-size:13px">{{ $message }}</div> @enderror
                            </div>
                        </div>
