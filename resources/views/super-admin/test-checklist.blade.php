    ...
    <div class="test-checklist-page" x-data="checklistApp()">
        <div class="checklist-stats-grid">
            <div class="stat-card stat-total">
                ...
                <div class="stat-label">{{ __('super-admin.test_total') }}</div>
            </div>
            <div class="stat-card stat-passed">
                <div class="stat-value" x-text="stats.passed"></div>
                <div class="stat-label">{{ __('super-admin.test_passed') }}</div>
            </div>
            <div class="stat-card stat-failed">
                <div class="stat-value" x-text="stats.failed"></div>
                <div class="stat-label">{{ __('super-admin.test_failed') }}</div>
            </div>
            <div class="stat-card stat-skipped">
                <div class="stat-value" x-text="stats.skipped"></div>
                <div class="stat-label">{{ __('super-admin.test_skipped') }}</div>
            </div>
            <div class="stat-card stat-pending">
                <div class="stat-value" x-text="stats.pending"></div>
                <div class="stat-label">{{ __('super-admin.test_pending') }}</div>
            </div>
            <div class="stat-card stat-overall">
                <div class="stat-value" x-text="progressPercent() + '%'"></div>
                <div class="stat-label">{{ __('super-admin.test_overall') }}</div>
        ...
        <div class="checklist-actions">
            <button class="btn btn-outline" @click="expandAll()">
                <i class="bi bi-arrows-expand"></i> {{ __('super-admin.test_expand_all') }}
            </button>
            <button class="btn btn-outline" @click="collapseAll()">
                <i class="bi bi-arrows-collapse"></i> {{ __('super-admin.test_collapse_all') }}
            </button>
            <button class="btn btn-outline-danger" @click="confirmReset">
                <i class="bi bi-arrow-counterclockwise"></i> {{ __('super-admin.test_reset') }}
            </button>
            <form method="POST" action="{{ route('super.admin.test-checklist.export-markdown') }}" style="display:inline">
                @csrf
                <button class="btn btn-outline" type="submit">
                    <i class="bi bi-filetype-md"></i> {{ __('super-admin.test_export_md') }}
                </button>
            </form>
            <form method="POST" action="{{ route('super.admin.test-checklist.import-markdown') }}" style="display:inline" onsubmit="return confirm('{{ __('super-admin.test_import_confirm') }}')">
                @csrf
                <button class="btn btn-outline" type="submit">
                    <i class="bi bi-filetype-md"></i> {{ __('super-admin.test_import_md') }}
                </button>
            </form>
        </div>
                                    ...
                                    <div class="checklist-item">
                                        <div class="item-main">
                                            ...
                                            <div class="item-notes-toggle">
                                                <button class="btn btn-sm btn-ghost" @click="toggleDetails(item.id)" title="{{ __('super-admin.test_details') }}" x-show="item.details">
                                                    <i class="bi bi-info-circle"></i>
                                                </button>
                                                <button class="btn btn-sm btn-ghost" @click="focusNotes(categoryName, item.id)" title="{{ __('general.notes') }}">
