<x-super-admin-layout>
    <x-slot:title>{{ __('super-admin.workspace_roles') }} - {{ config('app.name') }}</x-slot>
    <x-slot:page-title>{{ __('super-admin.workspace_roles') }}</x-slot>
    <x-slot:page-description>{{ __('super-admin.workspace_roles_desc') }}</x-slot>
                ...
                <div class="role-card">
                    <div class="role-card-header">
                        <div>
                            ...
                            <span class="role-card-slug">{{ $role->slug }}</span>
                        </div>
                    ...
                    <a href="{{ route('super.admin.workspace-roles.edit', $role) }}" class="btn" style="width:100%;padding:9px;font-size:13px;border-radius:var(--radius-sm);background:var(--accent);color:var(--primary);font-weight:600;border:none;text-decoration:none;display:inline-flex;align-items:center;justify-content:center;gap:6px;cursor:pointer;margin-top:16px">
