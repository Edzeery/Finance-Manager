        ...
        @foreach($roles as $role)
            <div class="col-md-6 col-lg-4">
                <div class="role-card">
                    ...
                    <a href="{{ route('super.admin.workspace-roles.edit', $role) }}" class="btn" style="width:100%;padding:9px;font-size:13px;border-radius:var(--radius-sm);background:var(--accent);color:#0F172A;font-weight:600;border:none;text-decoration:none;display:inline-flex;align-items:center;justify-content:center;gap:6px;cursor:pointer;margin-top:16px">
