...
return [
    ...
    'notifications' => [
        'notifications' => [
            BackupHasFailedNotification::class => ['log'],
            UnhealthyBackupWasFoundNotification::class => ['log'],
            CleanupHasFailedNotification::class => ['log'],
            BackupWasSuccessfulNotification::class => ['log'],
            HealthyBackupWasFoundNotification::class => ['log'],
            CleanupWasSuccessfulNotification::class => ['log'],
        ],
