...
<div class="auth-card animate-fade-in">
    ...
    <div class="auth-logo">
        ...
        <span class="logo-sub"><?php echo e(__('general.reset_password')); ?></span>
    </div>
...
<?php endif; ?>
        ...
        <button type="submit" class="btn btn-accent btn-custom w-100">
            <div wire:loading wire:target="resetPassword" class="spinner-border spinner-border-sm me-2" role="status"></div>
            <i class="bi bi-shield-check me-2" wire:loading.remove wire:target="resetPassword"></i>
            <?php echo e(__('general.reset_password')); ?>
...
</div><?php /**PATH C:\laragon\www\Finance-Manager\resources\views\livewire\pages\auth\reset-password.blade.php ENDPATH**/ ?>