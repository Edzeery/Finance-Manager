...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'status-kit::components.status-select','data' => ['domain' => 'goal','name' => 'status','selected' => old('status', $goal->status->value),'size' => 'md','set' => 'bi','placeholder' => ''.e(__('goal.in_progress')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['domain' => 'goal','name' => 'status','selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('status', $goal->status->value)),'size' => 'md','set' => 'bi','placeholder' => ''.e(__('goal.in_progress')).'']); ?>
