...
<?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('dashboard')); ?>"  class="btn btn-accent btn-custom mb-0 d-flex align-items-center gap-2">
                    <i class="bi bi-grid-1x2-fill me-1"></i><?php echo e(__('general.dashboard')); ?>

                </a>
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>"  class="btn btn-outline-secondary btn-custom mb-0 d-flex align-items-center gap-2">
                    <i class="bi bi-box-arrow-in-right me-1"></i><?php echo e(__('general.login')); ?>

                </a>
                <a href="<?php echo e(route('register')); ?>"  class="btn btn-accent btn-custom d-none d-sm-inline-flex mb-0 d-flex align-items-center gap-2">
    ...
    <section class="landing-hero">
        <div class="hero-content">
            ...
            <div class="hero-actions">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>"  class="btn btn-accent btn-custom btn-lg mb-0 d-flex align-items-center gap-2">
                        <i class="bi bi-grid-1x2-fill me-2"></i><?php echo e(__('general.dashboard')); ?>

                    </a>
                    <a href="<?php echo e(route('api.documentation')); ?>" class="btn btn-outline-secondary btn-custom btn-lg mb-0 d-flex align-items-center gap-2">
                        <i class="bi bi-book me-2"></i>API
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('register')); ?>"  class="btn btn-accent btn-custom btn-lg mb-0 d-flex align-items-center gap-2">
        ...
        <div class="hero-visual">
            <div class="hero-card hero-card-main">
                ...
                <div class="hero-card-body">
                    <div class="hc-row"><span class="hc-label"><?php echo e(__('general.monthly')); ?> <?php echo e(__('general.income')); ?></span><span class="hc-value hc-up">+$4,250</span></div>
                    <div class="hc-row"><span class="hc-label"><?php echo e(__('general.monthly')); ?> <?php echo e(__('general.expense')); ?></span><span class="hc-value hc-down">-$3,180</span></div>
                    <div class="hc-bar"><div class="hc-bar-fill" style="width:75%"></div></div>
                    <div class="hc-row"><span class="hc-label"><?php echo e(__('general.budget')); ?></span><span class="hc-value">75%</span></div>
                </div>
            </div>
    ...
    <section class="landing-how" style="padding:60px 0" id="api">
        ...
        <div style="text-align:center;max-width:600px;margin:0 auto">
            ...
            <p style="font-size:16px;color:var(--text-muted);margin-bottom:24px"><?php echo e(__('welcome.api_description')); ?></p>
            <div class="d-flex gap-3 justify-content-center flex-wrap">
                <a href="<?php echo e(route('api.documentation')); ?>" class="btn btn-accent btn-custom d-inline-flex align-items-center gap-2">
                    <i class="bi bi-book me-1"></i><?php echo e(__('developer.api_documentation_link')); ?>

                </a>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('account.settings.developer')); ?>" class="btn btn-outline-secondary btn-custom d-inline-flex align-items-center gap-2">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="pricing-card <?php if($plan->slug === 'business'): ?> pricing-featured <?php endif; ?>">
                    ...
                    <ul class="pricing-features" x-data="{ showAll: false }">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($plan->max_workspaces): ?>
                            <li><i class="bi bi-check-lg me-1"></i><?php echo e($plan->max_workspaces); ?> <?php echo e(__('workspace.title')); ?><?php echo e($plan->max_workspaces > 1 ? 's' : ''); ?></li>
                        <?php else: ?>
                            <li><i class="bi bi-check-lg me-1"></i><?php echo e(__('welcome.pricing_custom_workspaces')); ?></li>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($plan->max_users): ?>
                            <li><i class="bi bi-check-lg me-1"></i><?php echo e(__('welcome.pricing_up_to')); ?> <?php echo e($plan->max_users); ?> <?php echo e(__('workspace.members')); ?></li>
                        <?php else: ?>
                            <li><i class="bi bi-check-lg me-1"></i><?php echo e(__('welcome.pricing_unlimited_users')); ?></li>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($allFeatures->isNotEmpty()): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $allFeatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li x-show="showAll || <?php echo e($index < 3 ? 'true' : 'false'); ?>" x-transition:enter.duration.200ms>
                                    <i class="bi bi-check-lg me-1"></i><?php echo e($landingFeatureName($feature)); ?><?php echo e($feature->pivot->value ? ': ' . $feature->pivot->value : ''); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($allFeatures->count() > 3): ?>
                            <li>
                                <button @click="showAll = !showAll" type="button" class="btn btn-link p-0" style="font-size:13px;color:var(--accent);text-decoration:none">
                                    <span x-show="!showAll"><?php echo e(__('general.show_more')); ?> (<?php echo e($allFeatures->count() - 3); ?>)</span>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('dashboard')); ?>"  class="btn btn-accent btn-custom w-100"><?php echo e(__('general.dashboard')); ?></a>
                    <?php else: ?>
                        <a href="<?php echo e(route('register')); ?>"  class="btn btn-accent btn-custom w-100"><?php echo e($plan->button_text ?? __('welcome.pricing_cta')); ?></a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    ...
    <section class="landing-cta">
        <div class="cta-card">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('dashboard')); ?>"  class="btn btn-accent btn-custom btn-lg d-flex align-items-center gap-2 mx-auto" style="width:220px">
                    <i class="bi bi-grid-1x2-fill me-2"></i><?php echo e(__('general.dashboard')); ?>

                </a>
            <?php else: ?>
                <a href="<?php echo e(route('register')); ?>"  class="btn btn-accent btn-custom btn-lg d-flex align-items-center gap-2 mx-auto" style="width:220px">
                    <i class="bi bi-person-plus me-2"></i><?php echo e(__('welcome.hero_cta_started')); ?>
