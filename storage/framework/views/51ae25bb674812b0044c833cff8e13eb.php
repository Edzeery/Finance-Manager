    ...
    <div class="kpi-grid stagger-fade-in mb-4">
        ...
        <div class="kpi-card kpi-blue">
            <div class="kpi-card-header">
                ...
                <span class="kpi-card-trend up"><i class="bi bi-check-circle"></i><?php echo e($data['active_workspaces']); ?> <?php echo e(__('general.active')); ?></span>
            </div>
        ...
        <div class="kpi-card kpi-green">
            <div class="kpi-card-header">
                ...
                <span class="kpi-card-trend up"><i class="bi bi-check-circle"></i><?php echo e($data['active_subscriptions']); ?> <?php echo e(__('super-admin.active')); ?></span>
            </div>
            ...
            <div class="kpi-card-compare">
                <i class="bi bi-x-circle"></i> <?php echo e($data['canceled_subscriptions']); ?> <?php echo e(__('super-admin.canceled')); ?>
        ...
        <div class="kpi-card kpi-amber">
            ...
            <div class="kpi-card-compare">
                <i class="bi bi-check-circle"></i> <?php echo e($data['completed_payments']); ?> <?php echo e(__('super-admin.completed')); ?>
        ...
        <div class="kpi-card kpi-purple">
            ...
            <div class="kpi-card-compare">
                <i class="bi bi-clock"></i> <?php echo e($data['expired_coupons'] ?? '—'); ?> <?php echo e(__('super-admin.expired')); ?>
    ...
    <div class="analytics-grid mb-4">
        <div class="section-card">
            ...
            <div class="section-card-body">
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="empty-state"><div class="empty-icon" style="background:var(--border);color:var(--text-muted)"><i class="bi bi-pie-chart"></i></div><h4><?php echo e(__('general.no_data')); ?></h4></div>
        ...
        <div class="section-card">
            ...
            <div class="section-card-body">
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="empty-state"><div class="empty-icon" style="background:var(--border);color:var(--text-muted)"><i class="bi bi-bar-chart"></i></div><h4><?php echo e(__('general.no_data')); ?></h4></div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-7">
            <div class="section-card">
                ...
                <div class="section-card-body p-0">
                    ...
                    <?php else: ?>
                        <div class="empty-state"><div class="empty-icon" style="background:var(--border);color:var(--text-muted)"><i class="bi bi-clock-history"></i></div><h4><?php echo e(__('general.no_data')); ?></h4></div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
        </div>
