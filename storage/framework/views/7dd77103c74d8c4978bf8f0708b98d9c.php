...
<div class="auth-card animate-fade-in">
    ...
    <div class="auth-logo">
        ...
        <span class="logo-sub"><?php echo e(__('general.login')); ?></span>
    </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-icon-wrap">
                ...
                <input wire:model="form.email" id="email" type="email" name="email" required autofocus
                    autocomplete="username" class="form-custom has-icon-left <?php $__errorArgs = ['form.email'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="mb-3">
            <div class="d-flex justify-content-between align-items-center mb-1">
                <label for="password" class="form-label-custom mb-0"><?php echo e(__('general.password')); ?></label>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('password.request')): ?>
                    <a href="<?php echo e(route('password.request')); ?>" wire:navigate class="link-muted">
                        <?php echo e(__('general.forgot_password')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.password-input','data' => ['wire:model' => 'form.password','id' => 'password','name' => 'password','required' => true,'autocomplete' => 'current-password','error' => 'form.password']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'form.password','id' => 'password','name' => 'password','required' => true,'autocomplete' => 'current-password','error' => 'form.password']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="mb-4">
            <label class="form-check-custom">
                ...
                <span><?php echo e(__('general.remember_me')); ?></span>
            </label>
        </div>
    ...
    <div class="auth-footer mb-2">
        <?php echo app('translator')->get('general.no_account'); ?>
        <a href="<?php echo e(route('register')); ?>" wire:navigate><?php echo e(__('general.register')); ?></a>
    </div>

    <div class="text-center mt-3 pt-2" style="border-top:1px solid var(--border);">
        <a href="<?php echo e(route('super.admin.login')); ?>" wire:navigate class="link-muted" style="opacity:.7">
            <i class="bi bi-shield me-1"></i><?php echo e(__('super-admin.enter_panel')); ?>

        </a>
    </div>

</div><?php /**PATH C:\laragon\www\Finance-Manager\resources\views\livewire/pages/auth/login.blade.php ENDPATH**/ ?>