...
<?php $component->withAttributes([]); ?>
    ...
    <form action="<?php echo e(route('super.admin.workspace-roles.update', $role)); ?>" method="POST">
            ...
            <div class="col-lg-8">
                <div class="section-card">
                    ...
                    <div class="section-card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="permission-grid">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $groupPerms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="permission-card <?php echo e(in_array($perm->id, $rolePermissions) ? 'has' : ''); ?> <?php echo e($role->slug === 'workspace_admin' ? 'disabled' : ''); ?>">
                                            <input type="checkbox" name="permissions[]" value="<?php echo e($perm->id); ?>"
                                                <?php echo e(in_array($perm->id, $rolePermissions) ? 'checked' : ''); ?>

                                                <?php echo e($role->slug === 'workspace_admin' ? 'disabled' : ''); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($role->slug === 'workspace_admin'): ?>
                            <div class="d-flex align-items-center gap-2" style="font-size:13px;background:var(--info-light);color:var(--info);border-radius:var(--radius-sm);padding:10px 14px">
                                ...
                                <?php echo e(__('super-admin.workspace_admin_permissions_locked')); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\Finance-Manager\resources\views\super-admin\workspace-role-edit.blade.php ENDPATH**/ ?>