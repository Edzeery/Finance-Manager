<template x-for="toast in toasts" :key="toast.id">
    <div class="toast-item"
        ...
        <button class="toast-close" @click="remove(toast.id)" aria-label="<?php echo e(__('general.close')); ?>" title="<?php echo e(__('general.close')); ?>">
            <i class="bi bi-x"></i>
        </button>
...
<?php /**PATH C:\laragon\www\Finance-Manager\resources\views/components/toast/item.blade.php ENDPATH**/ ?>