...
<head>
    ...
    <meta name="description" content="<?php echo e(config('app.name') . ' - ' . __('general.app_description')); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.navbar','data' => ['variant' => 'setup']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'setup']); ?>
...
</html><?php /**PATH C:\laragon\www\Finance-Manager\resources\views\layouts\auth-setup.blade.php ENDPATH**/ ?>