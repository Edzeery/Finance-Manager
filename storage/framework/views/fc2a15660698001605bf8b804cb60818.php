...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.guest','data' => ['title' => __('account.suspended')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('account.suspended'))]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'status-kit::components.status-icon','data' => ['domain' => 'user','status' => 'suspended','set' => 'bi']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['domain' => 'user','status' => 'suspended','set' => 'bi']); ?>
...
<?php endif; ?>
            ...
            <h2><?php echo e(__('account.suspended_title')); ?></h2>
            <p class="status-desc"><?php echo e(__('account.suspended_description')); ?></p>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->statusRecord?->status_reason): ?>
                <div class="status-info-card" style="background:var(--danger-light);color:var(--danger)">
                    ...
                    <div>
                        <strong><?php echo e(__('account.reason')); ?>:</strong>
                        <?php echo e(auth()->user()->statusRecord->status_reason); ?>

                    </div>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->statusRecord?->expires_at): ?>
                <div class="status-info-card" style="background:var(--warning-light);color:var(--warning)">
                    <i class="bi bi-clock-history"></i>
                    <div>
                        <strong><?php echo e(__('account.suspended_expires')); ?>:</strong>
                        <?php echo e(auth()->user()->statusRecord->expires_at->format('Y/m/d H:i')); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Finance-Manager\resources\views\account\status\suspended.blade.php ENDPATH**/ ?>