...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> <?php echo e(__('budget.add')); ?> - <?php echo e(config('app.name')); ?> <?php $__env->endSlot(); ?>
     <?php $__env->slot('pageTitle', null, []); ?> <?php echo e(__('budget.add')); ?> <?php $__env->endSlot(); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="name_fr" value="<?php echo e(old('name_fr')); ?>" class="form-custom <?php $__errorArgs = ['name_fr'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="name_en" value="<?php echo e(old('name_en')); ?>" class="form-custom <?php $__errorArgs = ['name_en'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                    <option value="monthly" <?php echo e(old('type') === 'monthly' ? 'selected' : ''); ?>><?php echo e(__('budget.monthly')); ?></option>
                                    <option value="yearly" <?php echo e(old('type') === 'yearly' ? 'selected' : ''); ?>><?php echo e(__('budget.yearly')); ?></option>
                                    <option value="custom" <?php echo e(old('type') === 'custom' ? 'selected' : ''); ?>><?php echo e(__('budget.custom')); ?></option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" required placeholder="0.00" id="budget_total">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.toggle-switch','data' => ['name' => 'is_active','checked' => old('is_active', '1'),'label' => ''.e(__('budget.is_active')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'is_active','checked' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('is_active', '1')),'label' => ''.e(__('budget.is_active')).'']); ?>
...
<?php endif; ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="start_date" value="<?php echo e(old('start_date', date('Y-m-d'))); ?>" class="form-custom <?php $__errorArgs = ['start_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required id="budget_start_date">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="end_date" value="<?php echo e(old('end_date')); ?>" class="form-custom <?php $__errorArgs = ['end_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="budget_end_date">
                                <small class="text-muted"><?php echo e(__('budget.auto_end_date_hint')); ?></small>
...
unset($__errorArgs, $__bag); ?>" style="width:120px" placeholder="0.00" value="<?php echo e(old('categories.' . $loop->index . '.allocated_amount')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Finance-Manager\resources\views\budget\create.blade.php ENDPATH**/ ?>