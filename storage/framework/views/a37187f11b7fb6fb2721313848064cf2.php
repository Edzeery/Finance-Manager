                                            ...
                                            <div class="flex-grow-1" style="min-width:0">
                                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isExpired): ?>
                                                        <span class="badge" style="background:var(--danger-light, #fef2f2);color:var(--danger);font-size:10px;padding:2px 8px;border-radius:20px;font-weight:600"><?php echo e(__('general.expired')); ?></span>
                                                    ...
                                                    <?php elseif($expiresSoon): ?>
                                                        <span class="badge" style="background:var(--warning-light, #fef3c7);color:var(--warning);font-size:10px;padding:2px 8px;border-radius:20px;font-weight:600"><?php echo e(__('general.expires_soon')); ?></span>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </div>
