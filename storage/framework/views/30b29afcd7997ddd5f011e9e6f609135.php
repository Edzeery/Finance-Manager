...
<?php if (! $__env->hasRenderedOnce('26a07c52-b909-4571-a408-35046b014e96')): $__env->markAsRenderedOnce('26a07c52-b909-4571-a408-35046b014e96'); ?>
    <style>
...
>
    ...
    >
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($searchable): ?>
            <li class="<?php echo e($classes['p_1_pb_2']); ?>">
                <input
                    ...
                    placeholder="<?php echo e(app()->getLocale() === 'ar' ? 'بحث...' : (app()->getLocale() === 'fr' ? 'Rechercher...' : 'Search...')); ?>"
                >
            </li>
        ...
        <li x-show="filteredOptions.length === 0" class="<?php echo e($classes['text_muted']); ?> <?php echo e($classes['small']); ?> <?php echo e($classes['px_2_py_1']); ?>">
            <?php echo e(app()->getLocale() === 'ar' ? 'لا توجد نتائج' : (app()->getLocale() === 'fr' ? 'Aucun résultat' : 'No results')); ?>

        </li>
    </ul>
</div>
<?php /**PATH C:\laragon\www\Finance-Manager\vendor\edzeery\mystatuskit\resources\views\components\status-select.blade.php ENDPATH**/ ?>