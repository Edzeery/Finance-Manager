...
# <?php echo e(__('emails.status_changed_subject', ['status' => __('account.' . strtolower($newStatus->value))])); ?>


<?php echo e(__('emails.hello')); ?>


<?php echo e(__('emails.status_changed_line', ['status' => __('account.' . strtolower($newStatus->value))])); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
- **<?php echo e(__('account.reason')); ?>:** <?php echo e($reason); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => $__env->getContainer()->make(Illuminate\View\Factory::class)->make('mail::button'),'data' => ['url' => $pageUrl]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($pageUrl)]); ?>
<?php echo e(__('emails.view_details')); ?>
...
<?php echo e(__('emails.status_changed_footer')); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Finance-Manager\resources\views\emails\user-status-changed.blade.php ENDPATH**/ ?>