...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> <?php echo e(__('income.edit')); ?> - <?php echo e(config('app.name')); ?> <?php $__env->endSlot(); ?>
     <?php $__env->slot('pageTitle', null, []); ?> <?php echo e(__('income.edit')); ?> <?php $__env->endSlot(); ?>

    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card-custom">
                <div class="card-body p-4">
                    <form action="<?php echo e(route('income.update', $income)); ?>" method="POST">
...
unset($__errorArgs, $__bag); ?>" required>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($cat->id); ?>" <?php echo e(old('category_id', $income->category_id) == $cat->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="number" step="0.01" min="0" name="amount" value="<?php echo e(old('amount', $income->amount)); ?>" class="form-custom <?php $__errorArgs = ['amount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="date" value="<?php echo e(old('date', $income->date->format('Y-m-d'))); ?>" class="form-custom <?php $__errorArgs = ['date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="description" value="<?php echo e(old('description', $income->description)); ?>" class="form-custom" maxlength="1000">
                            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.toggle-switch','data' => ['name' => 'is_recurring','id' => 'is_recurring','checked' => old('is_recurring', $income->is_recurring),'label' => ''.e(__('income.is_recurring')).'','hint' => ''.e(__('income.recurring_help')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'is_recurring','id' => 'is_recurring','checked' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('is_recurring', $income->is_recurring)),'label' => ''.e(__('income.is_recurring')).'','hint' => ''.e(__('income.recurring_help')).'']); ?>
...
<?php endif; ?>
                            ...
                            <div id="recurringFields" class="col-12 row g-3" style="display:<?php echo e(old('is_recurring', $income->is_recurring) ? 'flex' : 'none'); ?>">
                                <div class="col-md-6">
                                    ...
                                    <select name="recurring_frequency" class="form-custom">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = \App\Enums\RecurringFrequency::cases(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $freq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($freq->value); ?>" <?php echo e((old('recurring_frequency') ?? $income->recurring_frequency) === $freq->value ? 'selected' : ''); ?>>
                                                <?php echo e(__("income.{$freq->value}")); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="recurring_end_date" value="<?php echo e(old('recurring_end_date', $income->recurring_end_date?->format('Y-m-d'))); ?>" class="form-custom">
                                </div>
                            </div>

                            <div class="col-12">
                                <label class="form-label-custom"><?php echo e(__('income.notes')); ?></label>
                                <textarea name="notes" class="form-custom" rows="3" maxlength="1000"><?php echo e(old('notes', $income->notes)); ?></textarea>
                            </div>
                        </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Finance-Manager\resources\views/income/edit.blade.php ENDPATH**/ ?>