...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.filter-tabs','data' => ['tabs' => [
    ...
    ],'current' => ''.e($status ?? 'all').'','keyParam' => 'status','defaultKey' => 'all','preserve' => ['per_page']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['tabs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
        ...
        'unread' => ['label' => __('general.unread'), 'count' => $countUnread, 'icon' => 'bi-bell-fill'],
        'read' => ['label' => __('general.read'), 'count' => $countRead, 'icon' => 'bi-check-circle'],
    ]),'current' => ''.e($status ?? 'all').'','keyParam' => 'status','defaultKey' => 'all','preserve' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['per_page'])]); ?>
...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($notifications->hasPages()): ?>
        <div class="mt-3">
            <?php echo e($notifications->appends(request()->except('page'))->links()); ?>
