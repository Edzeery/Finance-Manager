    ...
    <div class="row g-3 mb-4">
        <div class="col-md-3">
            <div class="kpi-card">
                ...
                <div class="kpi-value"><?php echo e(number_format($totalValue, 2)); ?> <small
                        style="font-size:14px; font-weight:400; color:var(--text-muted)"><?php echo e(config('finance.currency_symbol')); ?></small>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="kpi-card">
                ...
                <div class="kpi-value"><?php echo e(number_format($liquidValue, 2)); ?> <small
                        style="font-size:14px; font-weight:400; color:var(--text-muted)"><?php echo e(config('finance.currency_symbol')); ?></small>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="kpi-card">
                ...
                <div class="kpi-value"><?php echo e(number_format($zakatableValue, 2)); ?> <small
                        style="font-size:14px; font-weight:400; color:var(--text-muted)"><?php echo e(config('finance.currency_symbol')); ?></small>
                </div>
            </div>
        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.filter-tabs','data' => ['tabs' => $tabs,'current' => ''.e($tab).'','defaultKey' => 'all','subParam' => 'type','subCurrent' => ''.e(request('type', '')).'','subTabs' => $showSubTabs ? $typeSubTabs : []]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['tabs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($tabs),'current' => ''.e($tab).'','defaultKey' => 'all','subParam' => 'type','subCurrent' => ''.e(request('type', '')).'','subTabs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($showSubTabs ? $typeSubTabs : [])]); ?>
...
<?php endif; ?>
    ...
    <form id="bulkForm" method="POST" data-bulk-delete-route="<?php echo e(route('asset.bulk-delete')); ?>"
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $assets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <form id="delete-form-asset-<?php echo e($asset->id); ?>" action="<?php echo e(route('asset.destroy', $asset)); ?>" method="POST"
            style="display:none">
            <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
        </form>
        <form id="force-delete-form-asset-<?php echo e($asset->id); ?>" action="<?php echo e(route('asset.force-delete', $asset->id)); ?>"
            ...
            <div id="bulkBar" class="bulk-bar" style="display:none; margin:12px">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tab === 'trashed'): ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canRestore): ?>
                        <button type="submit" form="bulkForm" formaction="<?php echo e(route('asset.bulk-restore')); ?>"
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $assets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr <?php if($tab === 'trashed'): ?> style="opacity:0.7" <?php endif; ?>>
                                    <td><input type="checkbox" name="ids[]" value="<?php echo e($asset->id); ?>"
                                            class="select-item" form="bulkForm"></td>
                                    <td>
                                        <?php if (isset($component)) { $__componentOriginal8c81617a70e11bcf247c4db924ab1b62 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8c81617a70e11bcf247c4db924ab1b62 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'status-kit::components.status-badge','data' => ['domain' => 'asset','status' => $asset->type->value,'set' => 'bi']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['domain' => 'asset','status' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($asset->type->value),'set' => 'bi']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                    ...
                                    <td>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($asset->type->value === 'gold' && $asset->karat): ?>
                                            <?php if (isset($component)) { $__componentOriginal8c81617a70e11bcf247c4db924ab1b62 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8c81617a70e11bcf247c4db924ab1b62 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'status-kit::components.status-badge','data' => ['domain' => 'general','status' => 'warning','set' => 'bi','size' => 'xs','class' => 'ms-1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('status-badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['domain' => 'general','status' => 'warning','set' => 'bi','size' => 'xs','class' => 'ms-1']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal8c81617a70e11bcf247c4db924ab1b62)): ?>
<?php $attributes = $__attributesOriginal8c81617a70e11bcf247c4db924ab1b62; ?>
...
<?php endif; ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($asset->description): ?>
                                            <br><small
                                                style="color:var(--text-muted)"><?php echo e($asset->description); ?></small>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </td>
                                    <td class="text-start">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($asset->type->value === 'gold' || $asset->type->value === 'silver') && $asset->weight_grams): ?>
                                            <?php echo e(number_format($asset->weight_grams, 4)); ?>g
                                        <?php else: ?>
                                            <?php echo e($asset->quantity ? number_format($asset->quantity, 4) : '—'); ?>

                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </td>
                                    <td class="text-start fw-bold"><?php echo e(number_format($asset->total_value, 2)); ?> <small
                                            style="font-weight:400; color:var(--text-muted)"><?php echo e(config('finance.currency_symbol')); ?></small>
                                    </td>
                                    <td>
...
<?php endif; ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasActions): ?>
                                        <td class="text-center">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tab === 'trashed'): ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canRestore): ?>
                                                    <form action="<?php echo e(route('asset.restore', $asset)); ?>"
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canForceDelete): ?>
                                                    <button type="button" class="action-btn"
                                                        ...
                                                        @click="confirmForceDelete('asset', <?php echo e($asset->id); ?>)">
                                            ...
                                            <?php else: ?>
                                                <div class="action-group justify-content-center">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canUpdate): ?>
                                                        <a href="<?php echo e(route('asset.edit', $asset)); ?>"
                                                            class="action-btn" title="<?php echo e(__('general.edit')); ?>">
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canDelete): ?>
                                                        <button type="button" class="action-btn"
                                                            ...
                                                            @click="confirmDelete('asset', <?php echo e($asset->id); ?>)">
