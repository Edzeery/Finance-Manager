...
<body>
    <div style="text-align:center;margin-bottom:20px">
        ...
        <span class="badge bg-<?php echo e($invoice->status->value === 'paid' ? 'success' : ($invoice->status->value === 'draft' ? 'warning' : ($invoice->status->value === 'overdue' ? 'danger' : 'secondary'))); ?>">
...
</html><?php /**PATH C:\laragon\www\Finance-Manager\resources\views\account\invoices-pdf.blade.php ENDPATH**/ ?>