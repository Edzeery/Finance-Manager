...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> <?php echo e(__('api-docs.page_title')); ?> - <?php echo e(config('app.name')); ?> <?php $__env->endSlot(); ?>

    <div class="api-docs">
        <div class="container">
            <div class="api-docs-header">
                <h1><?php echo e(__('api-docs.page_title')); ?></h1>
                <p><?php echo e(__('api-docs.page_description')); ?></p>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3 d-none d-lg-block">
                    <div class="position-sticky" style="top:2rem">
                        <nav style="border-inline-start:2px solid var(--border,#e5e7eb);padding-inline-start:1rem">
                            <strong style="font-size:0.8rem;text-transform:uppercase;letter-spacing:0.05em;color:var(--text-muted,#6b7280);display:block;margin-bottom:0.5rem"><?php echo e(__('api-docs.on_this_page')); ?></strong>
                            <a href="#introduction" style="display:block;padding:0.35rem 0;font-size:0.875rem;color:var(--text-muted,#6b7280);text-decoration:none"><?php echo e(__('api-docs.introduction_section')); ?></a>
                            <a href="#authentication" style="display:block;padding:0.35rem 0;font-size:0.875rem;color:var(--text-muted,#6b7280);text-decoration:none"><?php echo e(__('api-docs.authentication_section')); ?></a>
                            <a href="#endpoints" style="display:block;padding:0.35rem 0;font-size:0.875rem;color:var(--text-muted,#6b7280);text-decoration:none"><?php echo e(__('api-docs.endpoints_section')); ?></a>
                            <a href="#errors" style="display:block;padding:0.35rem 0;font-size:0.875rem;color:var(--text-muted,#6b7280);text-decoration:none"><?php echo e(__('api-docs.errors_section')); ?></a>
                            <a href="#rate-limits" style="display:block;padding:0.35rem 0;font-size:0.875rem;color:var(--text-muted,#6b7280);text-decoration:none"><?php echo e(__('api-docs.rate_limits_section')); ?></a>
                            <a href="#sdk" style="display:block;padding:0.35rem 0;font-size:0.875rem;color:var(--text-muted,#6b7280);text-decoration:none"><?php echo e(__('api-docs.sdk_section')); ?></a>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-lg-9">
                    <div class="api-docs-content">
                        ...
                        <h2 id="introduction"><?php echo e(__('api-docs.introduction_section')); ?></h2>
                        <p><?php echo e(__('api-docs.introduction')); ?></p>
                        <p><?php echo e(__('api-docs.base_url')); ?></p>
                        <div class="code-block-wrapper" dir="ltr">
                            <pre><code><?php echo e($baseUrl); ?></code></pre>
                        </div>

                        <h3><?php echo e(__('api-docs.quick_start')); ?></h3>
                        <p>Follow these steps to start using the API in minutes:</p>
                        <ol style="color:var(--text-muted,#6b7280);line-height:2">
                            <li><strong>Get your token:</strong> <code>POST <?php echo e($baseUrl); ?>/auth/login</code> with email and password</li>
                            <li><strong>Use the token:</strong> Include <code>Authorization: Bearer YOUR_TOKEN</code> in all requests</li>
                            <li><strong>Pick a workspace:</strong> List workspaces via <code>GET <?php echo e($baseUrl); ?>/workspaces</code> and get the ID</li>
                            <li><strong>Manage data:</strong> Use workspace endpoints like <code><?php echo e($baseUrl); ?>/workspace/incomes</code></li>
                        </ol>

                        <h2 id="authentication"><?php echo e(__('api-docs.authentication_section')); ?></h2>
                        <p><?php echo e(__('api-docs.authentication_description')); ?></p>
                        <div class="info-box"><p><strong><?php echo e(__('api-docs.authentication_note')); ?></strong></p></div>
                        <p><?php echo e(__('api-docs.how_to_get_token')); ?></p>
                        <p><?php echo e(__('api-docs.how_to_get_token2')); ?></p>
                        <p><?php echo e(__('api-docs.how_to_get_token3')); ?></p>

                        <h3><?php echo e(__('api-docs.common_operations')); ?></h3>
                        <p>Full code examples for the most frequently used API operations.</p>

                        <h4><?php echo e(__('api-docs.list_incomes_example')); ?></h4>
                        <?php echo $__env->make('api-docs._code_block', ['id'=>'list-incomes','examples'=>[
...
const data = await response.json();',
                        ],'response'=>json_encode(['data'=>[['id'=>1,'amount'=>1000,'description'=>'Freelance','category'=>'Freelance','date'=>'2025-06-01']],'meta'=>['current_page'=>1,'per_page'=>15,'total'=>1,'last_page'=>1]], JSON_PRETTY_PRINT)], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                        <h4><?php echo e(__('api-docs.create_income_example')); ?></h4>
                        <?php echo $__env->make('api-docs._code_block', ['id'=>'create-income','examples'=>[
...
const result = await response.json();',
                        ],'response'=>json_encode(['id'=>1,'amount'=>1500,'description'=>'Freelance project','category_id'=>1,'date'=>'2025-06-15','message'=>'Income created successfully'], JSON_PRETTY_PRINT)], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                        <?php echo $__env->make('api-docs._code_block', ['id'=>'auth','examples'=>[
...
res = Net::HTTP.start(uri.hostname, uri.port, use_ssl:true) {|h| h.request(req)}',
                        ],'response'=>json_encode(['user'=>['id'=>1,'name'=>'John Doe','email'=>'user@example.com'],'token'=>'1|abc123...','message'=>'Login successful'], JSON_PRETTY_PRINT)], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                        <h2 id="endpoints"><?php echo e(__('api-docs.endpoints_section')); ?></h2>
                        <p><?php echo e(__('api-docs.endpoints_description')); ?></p>
                        <p class="small text-muted"><?php echo e(__('api-docs.with_abilities')); ?> <span class="ability-tag">*</span></p>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $grouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupKey => $endpoints): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <h3 class="mt-4"><i class="<?php echo e($groupIcons[$groupKey] ?? 'bi-chevron-right'); ?> me-1"></i> <?php echo e(__("api-docs.{$groupKey}")); ?></h3>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $endpoints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if (isset($component)) { $__componentOriginal36ecc36b22a8e481be6bb2863f90d4d9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal36ecc36b22a8e481be6bb2863f90d4d9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.api-endpoint','data' => ['method' => ''.e($ep['method']).'','endpoint' => ''.e($ep['endpoint']).'','desc' => ''.e(__($ep['desc_key'])).'','ability' => ''.e($ep['ability']).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('api-endpoint'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['method' => ''.e($ep['method']).'','endpoint' => ''.e($ep['endpoint']).'','desc' => ''.e(__($ep['desc_key'])).'','ability' => ''.e($ep['ability']).'']); ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($ep['params'])): ?>
                                        <h4><?php echo e(__('api-docs.parameters')); ?></h4>
                                        <div class="table-responsive"><table class="param-table">
                                            <thead><tr><th><?php echo e(__('api-docs.parameters')); ?></th><th>Type</th><th><?php echo e(__('api-docs.description')); ?></th></tr></thead>
                                            <tbody>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $ep['params']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr><td><?php echo e($p[0]); ?> <?php echo $p[3] ? '<span class="param-required">*</span>' : ''; ?></td><td class="param-type"><?php echo e($p[1]); ?></td><td><?php echo e($p[2]); ?></td></tr>
                                    ...
                                    ?>
                                    <?php echo $__env->make('api-docs._code_block', ['examples'=>['curl'=>$curlEx],'id'=>'ep-'.Str::slug($url)], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal36ecc36b22a8e481be6bb2863f90d4d9)): ?>
<?php $attributes = $__attributesOriginal36ecc36b22a8e481be6bb2863f90d4d9; ?>
<?php unset($__attributesOriginal36ecc36b22a8e481be6bb2863f90d4d9); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal36ecc36b22a8e481be6bb2863f90d4d9)): ?>
<?php $component = $__componentOriginal36ecc36b22a8e481be6bb2863f90d4d9; ?>
<?php unset($__componentOriginal36ecc36b22a8e481be6bb2863f90d4d9); ?>
<?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                        <h2 id="errors"><?php echo e(__('api-docs.error_codes_title')); ?></h2>
                        <div class="table-responsive"><table class="param-table" style="margin-bottom:1.5rem">
                            <thead><tr><th>Code</th><th><?php echo e(__('api-docs.description')); ?></th></tr></thead>
                            <tbody>
                                <tr><td><span class="badge bg-danger">401</span></td><td><?php echo e(__('api-docs.error_401')); ?></td></tr>
                                <tr><td><span class="badge bg-warning text-dark">403</span></td><td><?php echo e(__('api-docs.error_403')); ?></td></tr>
                                <tr><td><span class="badge bg-secondary">404</span></td><td><?php echo e(__('api-docs.error_404')); ?></td></tr>
                                <tr><td><span class="badge bg-info text-dark">422</span></td><td><?php echo e(__('api-docs.error_422')); ?></td></tr>
                                <tr><td><span class="badge bg-warning text-dark">429</span></td><td><?php echo e(__('api-docs.error_429')); ?></td></tr>
                                <tr><td><span class="badge bg-danger">500</span></td><td><?php echo e(__('api-docs.error_500')); ?></td></tr>
                            </tbody>
                        </table></div>

                        <h2 id="rate-limits"><?php echo e(__('api-docs.rate_limits_title')); ?></h2>
                        <p><?php echo e(__('api-docs.rate_limits_desc')); ?></p>
                        <ul>
                            <li><?php echo e(__('api-docs.rate_general')); ?></li>
                            <li><?php echo e(__('api-docs.rate_workspace')); ?></li>
                        </ul>
                        <p><?php echo e(__('api-docs.rate_exceeded')); ?></p>
                        <p><strong>Headers:</strong> <code>X-RateLimit-Limit</code>, <code>X-RateLimit-Remaining</code>, <code>Retry-After</code></p>

                        <h2 id="sdk"><?php echo e(__('api-docs.sdk_title')); ?></h2>
                        <p><?php echo e(__('api-docs.sdk_description')); ?></p>
                        <div class="grid-3">
                            <div class="sdk-card">
                                <i class="bi bi-code-square"></i>
                                <h4><?php echo e(__('api-docs.sdk_php')); ?></h4>
                                <p><?php echo e(__('api-docs.sdk_php_desc')); ?></p>
                                <code style="font-size:0.8rem">composer require finance-manager/client</code>
                            </div>
                            <div class="sdk-card">
                                <i class="bi bi-braces"></i>
                                <h4><?php echo e(__('api-docs.sdk_js')); ?></h4>
                                <p><?php echo e(__('api-docs.sdk_js_desc')); ?></p>
                                <code style="font-size:0.8rem">npm install finance-manager-client</code>
                            </div>
                            <div class="sdk-card">
                                <i class="bi bi-terminal"></i>
                                <h4><?php echo e(__('api-docs.sdk_python')); ?></h4>
                                <p><?php echo e(__('api-docs.sdk_python_desc')); ?></p>
    ...
    function initApiDocs() {
        ...
        document.querySelectorAll('.copy-btn').forEach(function(btn) {
            btn.addEventListener('click', function() {
                ...
                var done = function() { btn.textContent = '<?php echo e(__("api-docs.code_copied")); ?>'; setTimeout(function() { btn.textContent = orig; }, 2000); };
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Finance-Manager\resources\views\api-docs\index.blade.php ENDPATH**/ ?>