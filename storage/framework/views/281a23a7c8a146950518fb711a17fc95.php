...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> <?php echo e(__('expense.categories')); ?> - <?php echo e(config('app.name')); ?> <?php $__env->endSlot(); ?>
     <?php $__env->slot('pageTitle', null, []); ?> <?php echo e(__('expense.categories')); ?> <?php $__env->endSlot(); ?>

    <div class="row g-4">
        <div class="col-lg-4">
            <div class="card-custom">
                <div class="card-body p-4">
                    <h5 class="mb-3" style="font-size:15px; font-weight:600"><?php echo e(__('general.add')); ?> <?php echo e(__('expense.category')); ?></h5>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name_en')); ?>" required maxlength="255">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-6">
                                ...
                                <input type="text" name="icon" class="form-custom" value="<?php echo e(old('icon', 'bi-cart')); ?>" maxlength="50" placeholder="bi-cart">
                            </div>
                            <div class="col-6">
                                <label class="form-label-custom"><?php echo e(__('general.color')); ?></label>
                                <input type="color" name="color" class="form-custom" value="<?php echo e(old('color', '#EF4444')); ?>" style="height:42px; padding:4px">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label class="form-label-custom"><?php echo e(__('expense.type')); ?></label>
                            <select name="type" class="form-custom">
                                <option value="variable" <?php echo e(old('type') === 'variable' ? 'selected' : ''); ?>><?php echo e(__('expense.variable')); ?></option>
                                <option value="fixed" <?php echo e(old('type') === 'fixed' ? 'selected' : ''); ?>><?php echo e(__('expense.fixed')); ?></option>
                                <option value="periodic" <?php echo e(old('type') === 'periodic' ? 'selected' : ''); ?>><?php echo e(__('expense.periodic')); ?></option>
                            </select>
                        </div>
                        <div class="mb-3">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-custom badge-expense"><?php echo e(__("expense.{$cat->type}")); ?></span>
                                        </td>
                                        <td>
                                            <?php if (isset($component)) { $__componentOriginal8c81617a70e11bcf247c4db924ab1b62 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8c81617a70e11bcf247c4db924ab1b62 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'status-kit::components.status-badge','data' => ['domain' => 'general','status' => $cat->is_active ? 'active' : 'inactive','set' => 'bi']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['domain' => 'general','status' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($cat->is_active ? 'active' : 'inactive'),'set' => 'bi']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
            ...
            <div class="modal-content modal-custom">
                <form id="editForm" method="POST" data-categories='<?php echo json_encode($categories->items(), 15, 512) ?>'>
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title"><?php echo e(__('general.edit')); ?> <?php echo e(__('expense.category')); ?></h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="type" id="edit_type" class="form-custom">
                                <option value="variable"><?php echo e(__('expense.variable')); ?></option>
                                <option value="fixed"><?php echo e(__('expense.fixed')); ?></option>
                                <option value="periodic"><?php echo e(__('expense.periodic')); ?></option>
                            </select>
                        </div>
                        <div>
                            <?php if (isset($component)) { $__componentOriginal319c173192d983146c5bd67854bb9452 = $component; } ?>
...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <form id="delete-form-category-<?php echo e($cat->id); ?>" action="<?php echo e(route('expense.categories.destroy', $cat)); ?>" method="POST" style="display:none">
    ...
    function editCategory(id) {
        ...
        document.getElementById('edit_icon').value = cat.icon || 'bi-cart';
        document.getElementById('edit_color').value = cat.color || '#EF4444';
        document.getElementById('edit_type').value = cat.type;
        setToggle('edit_is_active', Boolean(cat.is_active));
        document.getElementById('editForm').action = '<?php echo e(route('expense.categories.update', ':id')); ?>'.replace(':id', id);
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Finance-Manager\resources\views\expense\categories.blade.php ENDPATH**/ ?>