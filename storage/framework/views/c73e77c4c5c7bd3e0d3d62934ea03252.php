...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> <?php echo e(__('report.yearly')); ?> - <?php echo e(config('app.name')); ?> <?php $__env->endSlot(); ?>
     <?php $__env->slot('pageTitle', null, []); ?> <?php echo e(__('report.yearly')); ?> <?php $__env->endSlot(); ?>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-md-3">
            <div class="kpi-card">
                ...
                <div class="kpi-label"><?php echo e(__('report.monthly_trend')); ?></div>
                <div class="kpi-value"><?php echo e($report['monthlyIncome']->count()); ?>/12</div>
            </div>
        </div>
    </div>
    ...
    <div class="card-custom mb-4">
                <div class="card-header-custom">
                    <h5 class="mb-0 d-flex align-items-center gap-2">
                        ...
                        <span><?php echo e(__('report.monthly_trend')); ?></span>
                    </h5>
                </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-custom mb-0">
                    <thead>
                        <tr>
                            <th><?php echo e(__('general.month')); ?></th>
                            <th class="text-end"><?php echo e(__('report.monthly_income')); ?></th>
                            <th class="text-end"><?php echo e(__('report.monthly_expense')); ?></th>
                            <th class="text-end"><?php echo e(__('report.net_savings')); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = range(1, 12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <tr>
                                <td><?php echo e(\Carbon\Carbon::createFromDate($year, $m, 1)->translatedFormat('F')); ?></td>
                                <td class="text-end text-success"><?php echo e(Number::currency($mIncome, config('finance.currency_symbol'))); ?></td>
                                <td class="text-end text-danger"><?php echo e(Number::currency($mExpense, config('finance.currency_symbol'))); ?></td>
                                <td class="text-end <?php echo e($mNet >= 0 ? 'text-success' : 'text-danger'); ?>">
                                    <?php echo e(Number::currency($mNet, config('finance.currency_symbol'))); ?>
                    ...
                    <tfoot>
                        <tr class="fw-bold">
                            ...
                            <td class="text-end"><?php echo e(Number::currency($report['totalIncome'], config('finance.currency_symbol'))); ?></td>
                            <td class="text-end"><?php echo e(Number::currency($report['totalExpense'], config('finance.currency_symbol'))); ?></td>
                            <td class="text-end <?php echo e($report['netSavings'] >= 0 ? 'text-success' : 'text-danger'); ?>">
                                <?php echo e(Number::currency($report['netSavings'], config('finance.currency_symbol'))); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Finance-Manager\resources\views\report\yearly.blade.php ENDPATH**/ ?>