...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'status-kit::components.status-icon','data' => ['domain' => 'general','status' => $current['icon'],'set' => 'bi','style' => 'font-size:64px;color:'.e($current['color']).';margin-bottom:16px']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['domain' => 'general','status' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($current['icon']),'set' => 'bi','style' => 'font-size:64px;color:'.e($current['color']).';margin-bottom:16px']); ?>
