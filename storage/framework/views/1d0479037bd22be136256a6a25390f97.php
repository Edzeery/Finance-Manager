...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.empty-state','data' => ['icon' => 'bi bi-'.e(request('status') === 'trashed' ? 'trash' : 'people').'','title' => __('general.no_data'),'description' => request('status') === 'trashed' ? __('messages.no_trashed') : __('messages.no_results')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'bi bi-'.e(request('status') === 'trashed' ? 'trash' : 'people').'','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('general.no_data')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request('status') === 'trashed' ? __('messages.no_trashed') : __('messages.no_results'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
