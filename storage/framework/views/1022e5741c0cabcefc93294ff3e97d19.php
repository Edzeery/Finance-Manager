...
<div class="onboarding-wrapper ">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if( $pendingPayment  ?? null && $pendingPlanInfo): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'status-kit::components.status-icon','data' => ['domain' => 'general','status' => 'warning','set' => 'bi','class' => 'fs-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['domain' => 'general','status' => 'warning','set' => 'bi','class' => 'fs-4']); ?>
...
<?php endif; ?>
            ...
            <div class="flex-grow-1">
                <strong class="d-block mb-1"
                    style="color: #856404;"><?php echo e(__('onboarding.pending_payment_title')); ?></strong>
                <p class="mb-2 small" style="color: #856404;">
                    <?php echo e(__('onboarding.pending_plan_banner', ['plan' => $pendingPlanInfo['name'] ?? ''])); ?>

                </p>
                <div class="d-flex gap-2">
                    <a href="<?php echo e(route('payment.status', $pendingPayment)); ?>"
                        class="btn btn-sm btn-warning text-dark fw-semibold">
                        <i class="bi bi-arrow-right-circle"></i> <?php echo e(__('onboarding.resume_payment')); ?>
    ...
    <div class="billing-toggle">
        <span
            class="billing-label <?php echo e($billingPeriod === 'monthly' ? 'active' : ''); ?>"><?php echo e(__('onboarding.monthly')); ?></span>
        ...
        <span
            class="billing-label <?php echo e($billingPeriod === 'yearly' ? 'active' : ''); ?>"><?php echo e(__('onboarding.yearly')); ?></span>
    </div>
    ...
    <div class="plan-grid">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="plan-card <?php echo e($selectedPlanId === $plan['id'] ? 'selected' : ''); ?> <?php echo e($isPopular ? 'popular' : ''); ?>"
                ...
                wire:key="plan-<?php echo e($plan['id']); ?>" x-data="{ showAll: false }">
                ...
                <div class="plan-card-content">
                    ...
                    <div class="plan-price">
                        ...
                        <?php else: ?>
                            ...
                            <span
                                class="price-period"><?php echo e($billingPeriod === 'yearly' ? __('onboarding.per_year') : __('onboarding.per_month')); ?></span>
                    ...
                    ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($des_plan ?? null): ?>
                        <p class="plan-desc"> <?php echo e($des_plan); ?> </p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php endif; ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($features) > 5): ?>
                                <li class="plan-features-toggle">
                                    <button type="button" class="plan-features-btn" @click.stop="showAll = !showAll">
                                        <span x-show="!showAll"><?php echo e(__('onboarding.show_more')); ?>

                                            (<?php echo e(count($features) - 5); ?>) <i class="bi bi-chevron-down"></i></span>
                                        <span x-show="showAll" x-cloak><?php echo e(__('onboarding.show_less')); ?> <i
                        ...
                        <?php else: ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = is_array($plan['features'] ?? null) ? $plan['features'] : []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><?php if (isset($component)) { $__componentOriginal916418750eca0f0299436c8f1a00baec = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal916418750eca0f0299436c8f1a00baec = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'status-kit::components.status-icon','data' => ['domain' => 'general','status' => 'success','set' => 'bi']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('status-icon'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php $component = $__componentOriginal916418750eca0f0299436c8f1a00baec; ?>
<?php unset($__componentOriginal916418750eca0f0299436c8f1a00baec); ?>
<?php endif; ?> <?php echo e($feature); ?></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </ul>
                </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php $isTrialPlan = $selectedPlan && !($selectedPlan['is_free'] ?? false) && ($selectedPlan['trial_days'] ?? 0) > 0; ?>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedPlan && !($selectedPlan['is_free'] ?? false) && !$isTrialPlan): ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paymentMethod === 'delivery'): ?>
                <div class="noest-form mb-3">
                    <div class="noest-form-header">
                        <i class="bi bi-geo-alt"></i>
                        <span><?php echo e(__('onboarding.delivery_info')); ?></span>
                    </div>
                    <div class="form-floating-group mb-3">
                        <input type="text" id="delivery_address" class="form-control" wire:model="deliveryAddress"
                            placeholder=" " <?php if($isProcessing): echo 'disabled'; endif; ?>>
                        <label for="delivery_address"><?php echo e(__('onboarding.delivery_address')); ?> <span
                                class="text-danger">*</span></label>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['deliveryAddress'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="form-floating-group">
                        <input type="text" id="delivery_phone" class="form-control" wire:model="deliveryPhone"
                            placeholder=" " <?php if($isProcessing): echo 'disabled'; endif; ?>>
                        <label for="delivery_phone"><?php echo e(__('onboarding.delivery_phone')); ?> <span
                                class="text-danger">*</span></label>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['deliveryPhone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                ...
                <div class="noest-form mb-3">
                    ...
                    <div class="form-floating-group mb-3">
                        <input type="text" id="noest_client" class="form-control" wire:model="noestClient"
                            placeholder=" " <?php if($isProcessing): echo 'disabled'; endif; ?>>
                        <label for="noest_client"><?php echo e(__('onboarding.noest_client')); ?> <span
                                class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating-group">
                                <input type="text" id="noest_phone" class="form-control" wire:model="noestPhone"
                                    placeholder=" " <?php if($isProcessing): echo 'disabled'; endif; ?>>
                                <label for="noest_phone"><?php echo e(__('onboarding.noest_phone')); ?> <span
                                        class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating-group">
                                <input type="text" id="noest_phone_2" class="form-control"
                                    wire:model="noestPhone2" placeholder=" " <?php if($isProcessing): echo 'disabled'; endif; ?>>
                    ...
                    <div class="form-floating-group mb-3">
                        <input type="text" id="noest_adresse" class="form-control" wire:model="noestAdresse"
                            placeholder=" " <?php if($isProcessing): echo 'disabled'; endif; ?>>
                        <label for="noest_adresse"><?php echo e(__('onboarding.noest_adresse')); ?> <span
                                class="text-danger">*</span></label>
                        ...
                        <div class="noest-search-group" x-data="{ search: '', items: [] }" x-init="items = JSON.parse($el.dataset.items)"
                            ...
                            <div class="form-floating">
                                <input type="text" x-model="search" class="form-control" id="noest_wilaya_search"
                                    placeholder="<?php echo e(__('onboarding.noest_search_wilaya')); ?>" autocomplete="off"
                                    <?php if($isProcessing): ?> disabled <?php endif; ?>>
                                <label for="noest_wilaya_search"><?php echo e(__('onboarding.noest_wilaya')); ?> <span
                                        class="text-danger">*</span></label>
                            </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="noest-search-group" x-data="{ search: '', items: [] }" x-init="items = JSON.parse($el.dataset.items)"
                            ...
                            <div class="form-floating">
                                <input type="text" x-model="search" class="form-control" id="noest_desk_search"
                                    placeholder="<?php echo e(__('onboarding.noest_search_desk')); ?>" autocomplete="off"
                                    <?php if(!$noestWilaya || $isProcessing): ?> disabled <?php endif; ?>>
                ...
                <div class="coupon-input-wrapper">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->couponValidation): ?>
                        <span class="coupon-status <?php echo e($this->couponValidation['valid'] ? 'valid' : 'invalid'); ?>">
                            <i
                                class="bi <?php echo e($this->couponValidation['valid'] ? 'bi-check-circle-fill' : 'bi-exclamation-circle-fill'); ?>"></i>
                        </span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->couponValidation): ?>
                    <div
                        class="coupon-message <?php echo e($this->couponValidation['valid'] ? 'text-success' : 'text-danger'); ?>">
    ...
    <?php elseif($isTrialPlan): ?>
        <button type="button" class="btn btn-accent btn-custom w-100 proceed-btn" wire:click="proceedTrial"
            ...
            <i class="bi bi-rocket-takeoff me-1"></i><?php echo e(__('onboarding.start_free_trial')); ?>
