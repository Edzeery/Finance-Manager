...
<div class="auth-card animate-fade-in">
    ...
    <div class="auth-logo">
        ...
        <span class="logo-sub"><?php echo e(__('general.register')); ?></span>
    </div>
    ...
    <form wire:submit="register" autocomplete="on">
        ...
        <div class="mb-3">
            <label for="name" class="form-label-custom"><?php echo e(__('general.name')); ?></label>
            <div class="input-icon-wrap">
                <i class="bi bi-person input-icon-left"></i>
                <input wire:model="name"
                       id="name" type="text" name="name"
                       required autofocus autocomplete="name"
                       class="form-custom has-icon-left <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>"
                       placeholder="<?php echo e(__('general.full_name')); ?>">
            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.password-input','data' => ['wire:model' => 'password','id' => 'password','name' => 'password','required' => true,'autocomplete' => 'new-password','error' => 'password']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'password','id' => 'password','name' => 'password','required' => true,'autocomplete' => 'new-password','error' => 'password']); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="mb-4">
            <label for="password_confirmation" class="form-label-custom"><?php echo e(__('general.confirm_password')); ?></label>
            <?php if (isset($component)) { $__componentOriginalb37ff04c7d1d761340845e7d275eabcc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalb37ff04c7d1d761340845e7d275eabcc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.password-input','data' => ['wire:model' => 'password_confirmation','id' => 'password_confirmation','name' => 'password_confirmation','required' => true,'autocomplete' => 'new-password']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('password-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'password_confirmation','id' => 'password_confirmation','name' => 'password_confirmation','required' => true,'autocomplete' => 'new-password']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalb37ff04c7d1d761340845e7d275eabcc)): ?>
<?php $attributes = $__attributesOriginalb37ff04c7d1d761340845e7d275eabcc; ?>
...
<?php endif; ?>
    ...
    <div class="auth-footer">
        <?php echo app('translator')->get('general.has_account'); ?>
        <a href="<?php echo e(route('login')); ?>" wire:navigate><?php echo e(__('general.login')); ?></a>
    </div>

</div><?php /**PATH C:\laragon\www\Finance-Manager\resources\views\livewire/pages/auth/register.blade.php ENDPATH**/ ?>