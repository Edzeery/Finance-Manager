        ...
        <div class="detail-main">
            <div class="section-card">
                <div class="section-card-header">
                    ...
                    <?php $bc = ['paid' => ['bg' => 'var(--success-light)', 'c' => 'var(--success)'], 'draft' => ['bg' => 'var(--warning-light)', 'c' => 'var(--warning)'], 'overdue' => ['bg' => 'var(--danger-light)', 'c' => 'var(--danger)'], 'cancelled' => ['bg' => 'var(--border)', 'c' => 'var(--text-muted)']]; ?>
                    <span class="badge" style="font-size:10px;background:<?php echo e($bc[$invoice->status->value]['bg'] ?? 'var(--border)'); ?>;color:<?php echo e($bc[$invoice->status->value]['c'] ?? 'var(--text-muted)'); ?>;padding:3px 12px;border-radius:6px;font-weight:600">
