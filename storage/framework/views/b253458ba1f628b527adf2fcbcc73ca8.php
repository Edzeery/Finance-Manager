    ...
    <div class="data-grid">
        <div class="data-grid-toolbar">
            <div class="data-grid-toolbar-left">
                <form method="GET" action="<?php echo e(route('super.admin.invoices.index')); ?>" class="d-flex flex-wrap align-items-center gap-2">
        ...
        <div class="data-grid-body">
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><code style="font-size:12px;background:var(--bg-subtle);padding:2px 8px;border-radius:4px"><?php echo e($invoice->number); ?></code></td>
                                <td><?php echo e($invoice->workspace?->name ?? '—'); ?></td>
                                <td><?php echo e($invoice->subscription?->plan?->name ?? '—'); ?></td>
                                <td><strong><?php echo e(number_format($invoice->total, 2)); ?> <?php echo e($invoice->currency ?? config('finance.currency_symbol')); ?></strong></td>
                                <td>
                                    <?php
                                    ...
                                    ?>
                                    <span class="badge" style="font-size:10px;background:<?php echo e($badge['bg']); ?>;color:<?php echo e($badge['color']); ?>;padding:3px 10px;border-radius:6px;font-weight:600"><?php echo e($invoice->status->label()); ?></span>
                                </td>
                                <td class="cell-muted"><?php echo e($invoice->created_at->format('Y/m/d')); ?></td>
                                <td class="col-actions">
                                    <a href="<?php echo e(route('super.admin.invoices.show', $invoice)); ?>" class="btn" style="width:30px;height:30px;padding:0;display:inline-flex;align-items:center;justify-content:center;border-radius:var(--radius-xs);border:1px solid var(--border);background:transparent;color:var(--text-muted);font-size:13px;text-decoration:none;transition:all 0.15s" title="<?php echo e(__('general.view')); ?>">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                </td>
                            </tr>
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <p><?php echo e(__('super-admin.no_invoices')); ?></p>
                </div>
