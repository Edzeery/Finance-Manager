...
class TestChecklistSeeder extends Seeder
{
    ...
    private function userItems(): array
    {
        return [
            ...
            // ----------------------------------------------------------------
            // US.2  الإعداد الأولي (Onboarding)  (15 items)
            // ----------------------------------------------------------------
            ...
            ['category' => 'لوحة المستخدم | 2. الإعداد الأولي', 'item_key' => 'onboarding.pending_block', 'description' => 'وجود دفع معلق ← منع الدخول إلى /onboarding/plan + التوجيه إلى payment.resume', 'details' => 'أنشئ دفعاً معلقاً (checkout.pending). اذهب إلى /onboarding/plan. يُمنع الدخول ويُوجّه إلى /payment/resume/{id}. تظهر تفاصيل الدفع فوراً. 3 أزرار: متابعة، تغيير طريقة، إلغاء.'],
            ['category' => 'لوحة المستخدم | 2. الإعداد الأولي', 'item_key' => 'onboarding.resume_continue', 'description' => '/payment/resume ← زر "متابعة الدفع" ← يعيد التوجيه إلى بوابة الدفع', 'details' => 'في صفحة resume، اضغط "متابعة الدفع". يُعاد التوجيه إلى بوابة الدفع.'],
            ['category' => 'لوحة المستخدم | 2. الإعداد الأولي', 'item_key' => 'onboarding.resume_cancel', 'description' => '/payment/resume ← زر "إلغاء الدفع" ← إلغاء الدفع + توجيه إلى /onboarding/plan', 'details' => 'في صفحة resume، اضغط "إلغاء الدفع". يُلغى الدفع. يُوجّه إلى /onboarding/plan.'],
            ['category' => 'لوحة المستخدم | 2. الإعداد الأولي', 'item_key' => 'onboarding.resume_switch', 'description' => '/payment/resume ← زر "تغيير طريقة الدفع" ← توجيه إلى /onboarding/payment', 'details' => 'في صفحة resume، اضغط "تغيير طريقة الدفع". يُوجّه إلى /onboarding/payment حيث يمكن اختيار طريقة جديدة.'],
            ...
            ['category' => 'لوحة المستخدم | 2. الإعداد الأولي', 'item_key' => 'onboarding.fee_breakdown_payment', 'description' => 'عرض تفصيل الرسوم في /onboarding/payment عند اختيار طريقة دفع', 'details' => 'اذهب إلى /onboarding/payment (يوجد باقة مختارة). اختر طريقة دفع. يظهر تحليل السعر مع الرسوم.'],
            ['category' => 'لوحة المستخدم | 2. الإعداد الأولي', 'item_key' => 'onboarding.fee_breakdown_retry', 'description' => 'عرض تفصيل الرسوم في /payment/retry/{id} من سجل الدفع', 'details' => 'اذهب إلى /payment/retry/{id} لدفع فاشل/ملغي. يظهر تفصيل الرسوم من سجل الدفع المخزّن.'],
            ...
            // ----------------------------------------------------------------
            // US.15  بوابات الدفع (وجهة مستخدم)  (14 items)
            // ----------------------------------------------------------------
            ...
            ['category' => 'لوحة المستخدم | 15. بوابات الدفع', 'item_key' => 'chargily.payment_success', 'description' => 'Chargily: دفع ناجح ← اشتراك Active + فاتورة Paid', 'details' => 'استخدم CIB أو Edahabia. بعد الدفع، يُوجّه إلى /payment/chargily/result. تتحدّث حالة payment.'],
            ...
            ['category' => 'لوحة المستخدم | 15. بوابات الدفع', 'item_key' => 'payment.features_collapse', 'description' => 'صفحة الدفع تعرض الميزات مع توسيع/طي (أول 5)', 'details' => 'اذهب إلى /onboarding/payment. تظهر أول 5 ميزات مع زر "عرض المزيد".'],
            ['category' => 'لوحة المستخدم | 15. بوابات الدفع', 'item_key' => 'plan.features_collapse', 'description' => 'بطاقات الخطط تعرض أول 5 ميزات مع توسيع/طي لكل بطاقة', 'details' => 'اذهب إلى /onboarding/plan. كل بطاقة تعرض أول 5 ميزات. زر مستقل لكل بطاقة.'],
