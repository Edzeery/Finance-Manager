...
class BudgetPolicyTest extends TestCase
{
    ...
    {
        $this->assertTrue($this->policy->view($this->user, $this->budget));
    }

    public function test_view_returns_false_for_other_user(): void
    {
        $this->assertFalse($this->policy->view($this->otherUser, $this->budget));
    }
    ...
    {
        $this->assertTrue($this->policy->update($this->user, $this->budget));
    }

    public function test_update_returns_false_for_other_user(): void
    {
        $this->assertFalse($this->policy->update($this->otherUser, $this->budget));
    }

    public function test_delete_returns_true_for_owner(): void
    {
        $this->assertTrue($this->policy->delete($this->user, $this->budget));
    }

    public function test_delete_returns_false_for_other_user(): void
    {
        $this->assertFalse($this->policy->delete($this->otherUser, $this->budget));
    }

    public function test_restore_returns_true_for_owner(): void
    {
        $this->assertTrue($this->policy->restore($this->user, $this->budget));
    }

    public function test_restore_returns_false_for_other_user(): void
    {
        $this->assertFalse($this->policy->restore($this->otherUser, $this->budget));
    }
}
